...
打亚服的时候，队友发来的消息经常看不懂，韩语、日语、英语都有，交流全靠脑补，玩起来特别别扭。后来想着能不能截个图自动翻译一下，于是就动手写了这个小工具。

功能上支持手动截图翻译和自动监听两种模式，识别到文字后会翻译成中文并显示在画面旁边。用的是 PaddleOCR 做文字识别，百度翻译做翻译，Qt 做界面，整体打包成了一个 Windows 可执行文件，解压就能用。

前后搞了几天，功能基本能用，放出来给有同样需求的人试试。欢迎反馈问题和建议。有问题也可以直接发到我的邮箱:605126199@qq.com
...
[DeepSeek](https://deepseek.com/) - 代码辅助与技术支持
